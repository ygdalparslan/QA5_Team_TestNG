...
public class TC11 {
    ...
    public void testCase11(){
        ...
        //11	"New password" kutucuğuna "Comfirm password" ile uyuşmayan parola girilir
        p05EditAccountDetailsPage.editAccountDetailsNewPasswordBox.sendKeys("Serhan12346.");
