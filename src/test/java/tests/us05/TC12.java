...
public class TC12 {
    ...
    public void testCase12(){
        ...
        //12	"Comfirm password" kutucuğuna "new password" ile uyuşmayan  parola girilir
        p05EditAccountDetailsPage.editAccountDetailsConfirmPasswordBox.sendKeys("Serhan12346.");
