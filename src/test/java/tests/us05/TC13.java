...
public class TC13 {
    ...
    public void testCase13(){
        ...
        //8	Email address kutucuğu doldurulur
        ...
        //11	"New password" kutucuğuna yeni ama 12 karakterden az bir parola girilir
        p05EditAccountDetailsPage.editAccountDetailsNewPasswordBox.sendKeys("Serhan123");

        //12	"Comfirm password" kutucuğuna "new password"a girilen parola girilir	Serhan12345.
        p05EditAccountDetailsPage.editAccountDetailsConfirmPasswordBox.sendKeys("Serhan123");
        ...
        //Test failed
        //Bug: Şifreler 12 karakterden az olunca kabul olmamalıyken, 9 karakterli "Serhan123" şifresi kabul edildi.
