...
public class TC10 {
    ...
    public void testCase10(){
        ...
        //10	"Current password" kutucuğuna yanlış parola girilir
        Driver.getDriver().switchTo().parentFrame();
        p05EditAccountDetailsPage.editAccountDetailsPassword_currentBox.sendKeys("Serhan123457.");
        ...
        //14	Değişiklik işleminin tamamlanmadığı doğrulanır->Your current password is incorrect.
        String expectedData="Your current password is incorrect.";
