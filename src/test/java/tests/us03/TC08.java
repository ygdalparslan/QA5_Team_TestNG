...
public class TC08 {
    ...
    public void testCase08(){
        ...
        //12	"Town / City" kutusu boş bırakılır
        p04MyAccountPage.billingTownCityBox.clear();
        ...
        //Kayıt işleminin gerçekleşmediğini doğrula. "Town / City is a required field." metni görülmeli
