...
public class TC02 {
    ...
    private final String testName = "US02 || TC02-Kullanıcı Daha Önceki Bilgiler İle kayıt Olamamalı";
    private final String description = "Siteye Daha Önceki Bilgiler İle kayıt Olunamamalıdır.";
